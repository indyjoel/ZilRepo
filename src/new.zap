...
START::
	CRLF
	CRLF
	PRINTI "Opening introductory text for Saint Mallory"
	CRLF
	CRLF
...
?L1:	CALL1 PARSER >RESULT
	...
	CALL2 STACK,M-END >RESULT
	CALL1 CLOCKER >RESULT
?L7:	LOC WINNER >HERE
?L3:	PUSH 0
	JUMP ?L1
...
?L16:	LESS? P-LEN,1 /?L19
	...
	EQUAL? STACK,W?$PERIOD,W?THEN /?L23
?L19:	ISAVE >USAVE
	EQUAL? USAVE,2 \?L23
...
?L23:	ZERO? P-CONT \?L36
	...
	GETB LEXBUF,1 >P-LEN
	JUMP ?L36
?L32:	PRINTI "Nothing to correct."
	CRLF
	RFALSE
?L30:	EQUAL? P-LEN,1 \?L35
	PRINTI "It's OK."
	CRLF
	RFALSE
?L35:	PRINTI "You can only correct one word at a time."
	CRLF
	RFALSE
?L36:	SET 'KEEP,0
	...
	ZERO? P-CONT \?L68
	EQUAL? READBUF,EDIT-READBUF /?L41
...
?L41:	ZERO? P-O-REASON /?L48
	CALL1 HANDLE-ORPHAN-RESPONSE >O-R
	EQUAL? O-R,O-RES-NOT-HANDLED /?L50
	SET 'WINNER,OW
	SET 'HERE,OH
	SET 'HERE-LIT,OHL
?L50:	EQUAL? O-R,O-RES-REORPHANED /FALSE
	EQUAL? O-R,O-RES-FAILED \?L55
	SET 'P-O-REASON,0
	RFALSE
?L55:	EQUAL? O-R,O-RES-SET-NP \?L56
	GETB P-SYNTAX,SYN-PREP1 >P-P1
	BTST P-O-REASON,P-OF-PRSI \?L57
...
?L57:	SET 'P-NOBJ,1
	JUMP ?L63
?L56:	EQUAL? O-R,O-RES-SET-PRSTBL \?L63
	BTST P-O-REASON,P-OF-PRSI \?L61
	SET 'KEEP,2
	JUMP ?L63
?L61:	SET 'KEEP,1
?L63:	SET 'P-O-REASON,0
?L48:	ZERO? O-R \?L68
	CALL1 CONVERT-ORDER-TO-TELL? >STACK
	ZERO? STACK /?L68
	GETB LEXBUF,1 >P-LEN
?L68:	EQUAL? O-R,O-RES-SET-NP,O-RES-SET-PRSTBL /?L73
	SET 'P-V,0
	SET 'P-NOBJ,0
	...
	ZERO? I \?L75
	SET 'I,1
?L75:	GRTR? I,P-LEN \?L79
	SET 'P-CONT,0
	JUMP ?L78
?L79:	CALL2 GETWORD?,I >W
	ZERO? W \?L81
	CALL2 PARSE-NUMBER?,I >STACK
	ZERO? STACK /?L82
	SET 'W,W?$002cNUMBER
	ZERO? W \?L81
?L82:	ICALL2 STORE-OOPS,I
	SET 'P-CONT,0
	...
	CRLF
	RFALSE
?L81:	EQUAL? W,W?THEN,W?$PERIOD \?L83
	ADD I,1 >P-CONT
	GRTR? P-CONT,P-LEN \?L84
	SET 'P-CONT,0
	JUMP ?L78
?L84:	ICALL COPY-READBUF,READBUF,CONT-READBUF
...
?L83:	ZERO? P-V \?L89
	...
	ZERO? V /?L89
	ZERO? DIR /?L90
	EQUAL? V,ACT?WALK \?L89
?L90:	SET 'P-V-WORD,W
	SET 'P-V-WORDN,I
	SET 'P-V,V
	JUMP ?L105
?L89:	ZERO? DIR \?L91
	EQUAL? P-V,0,ACT?WALK \?L91
	CALL CHKWORD?,W,PS?DIRECTION,P1?DIRECTION >VAL
	ZERO? VAL /?L91
	SET 'DIR,VAL
	SET 'DIR-WN,I
	JUMP ?L105
?L91:	CALL CHKWORD?,W,PS?PREPOSITION,0 >VAL
	ZERO? VAL /?L92
	ZERO? NOBJ \?L93
	ZERO? P-P1 \?L93
	SET 'P-P1,VAL
	JUMP ?L105
?L93:	EQUAL? NOBJ,1 \?L105
	ZERO? P-P2 \?L105
	SET 'P-P2,VAL
	JUMP ?L105
?L92:	CALL2 STARTS-NOUN-PHRASE?,W >STACK
	ZERO? STACK /?L97
	INC 'NOBJ
	EQUAL? NOBJ,1 \?L98
	CALL PARSE-NOUN-PHRASE,I,P-NP-DOBJ >VAL
	JUMP ?L101
?L98:	EQUAL? NOBJ,2 \?L100
...
?L121:	SET 'P-CONT,0
	RFALSE
?L117:	LESS? KEEP,2 \?L124
	CALL2 FIND-OBJECTS,KEEP >STACK
	ZERO? STACK \?L124
	SET 'P-CONT,0
	RFALSE
?L124:	EQUAL? PRSA,V?AGAIN /?L128
	ICALL2 SAVE-PARSER-RESULT,AGAIN-STORAGE
?L128:	ICALL SET-PRONOUNS,PRSO,P-PRSOS
	RTRUE
...
?L24:	SET 'P-NUMBER,V
	...
	.FUNCT PARSE-NOUN-PHRASE,WN,NP,SILENT?,SPEC,CNT,W,VAL,MODE,ADJ,NOUN,BUT,SPEC-WN,NW
	ASSIGNED? 'SILENT? /?L68
	SET 'SILENT?,0
?L68:	GET NP,1 >SPEC
	PUTB NP,1,0
...
?L8:	CALL1 RTN >STACK
	...
	JUMP ?L9
?L3:	CALL2 DARKNESS-F,M-DARK-TO-DARK >STACK
	ZERO? STACK \?L6
...
?L1:	PRINTC 32
	...
	CRLF
?L1:	PRINTI "Would you like to RESTART, UNDO, RESTORE, or QUIT? > "
?L6:	ICALL1 READLINE
	GETB LEXBUF,1 >STACK
	ZERO? STACK \?L9
	SET 'W,0
...
?L21:	CALL2 BLOCKS-TAKE?,HOLDER >STACK
	...
	CRLF
	RFALSE
?L25:	CALL2 TAKE-CAPACITY-CHECK,OBJ >STACK
	ZERO? STACK /?L29
...
?L1:	PRINTI "Nothing to repeat."
	CRLF
?L12:	ICALL2 RESTORE-PARSER-RESULT,TEMP-PARSER-RESULT
	RTRUE
