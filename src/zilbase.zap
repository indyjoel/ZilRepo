...
START::
	CRLF
	CRLF
	PRINTI "Opening text, something that sets the scene."
	CRLF
	CALL V-VERSION
	CRLF
...
?L1:	CRLF
	...
	.FUNCT COAT-R
	EQUAL? PRSA,V?EXAMINE \FALSE
	PRINTR "Nice clean coat."

	.FUNCT LEAFLET-R
	EQUAL? PRSA,V?EXAMINE \FALSE
	PRINTI "WELCOME TO ZORK!"
	CRLF
	PRINTR "ZORK is a game of adventure, danger, and low cunning. In it you will explore some of the most amazing territory ever seen by mortals. "

	.FUNCT CLOAK-R
	EQUAL? PRSA,V?EXAMINE \FALSE
	PRINTR "A nice round ball. "

	.FUNCT MAILBOX-R
	EQUAL? PRSA,V?OPEN \?L1
	PRINTI "You open the mailbox, revealing a leaflet inside."
	CRLF
	MOVE LEAFLET,HERE
	RTRUE
?L1:	EQUAL? PRSA,V?EXAMINE \FALSE
	PRINTR "A small mailbox, slightly weathered."
