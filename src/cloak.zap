...
START::
	CRLF
	CRLF
	PRINTI "Hurrying through the rainswept November night, you're glad to see the bright lights of the Opera House. It's surprising that there aren't more people about but, hey, what do you expect in a cheap demo game...?"
	CRLF
	CRLF
	CALL V-VERSION
	CRLF
...
?L1:	CRLF
	...
	.FUNCT CLOAK-R
	EQUAL? PRSA,V?EXAMINE \FALSE
	PRINTR "The cloak is unnaturally dark."

	.FUNCT BAR-R,RARG
	EQUAL? RARG,M-ENTER \?L1
	FSET? CLOAK,WORNBIT \?L3
	FCLEAR BAR,LIGHTBIT
	RTRUE
?L3:	FSET BAR,LIGHTBIT
	RTRUE
?L1:	EQUAL? RARG,M-BEG \FALSE
	FSET? BAR,LIGHTBIT /FALSE
	EQUAL? PRSA,V?QUIT,V?VERSION,V?WAIT /FALSE
	EQUAL? PRSA,V?SAVE,V?RESTORE,V?INVENTORY /FALSE
	EQUAL? PRSA,V?UNDO,V?SUPERBRIEF,V?BRIEF /FALSE
	EQUAL? PRSA,V?VERBOSE,V?AGAIN,V?SCRIPT /FALSE
	EQUAL? PRSA,V?UNSCRIPT,V?PRONOUNS,V?TELL /FALSE
	EQUAL? PRSA,V?LOOK /FALSE
	EQUAL? PRSA,V?WALK \?L9
	EQUAL? PRSO,P?NORTH /FALSE
?L9:	PRINTI "You grope around clumsily in the dark. Better be careful."
	CRLF
	INC 'DISTURBED
	RETURN DISTURBED
	...
	PRINTI "The message simply reads: ""You "
	GRTR? DISTURBED,1 \?L3
	PRINTI "lose."
	JUMP ?L5
?L3:	PRINTI "win."
